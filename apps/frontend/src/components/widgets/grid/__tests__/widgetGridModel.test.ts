...
const placements: WidgetPlacement[] = [
  { id: 'wide', type: 'adherenceWide', colSpan: 2, row: 0, column: 0 },
  { id: 'small', type: 'tonnageCompact', colSpan: 1, row: 0, column: 2 },
  { id: 'chart', type: 'e1rmWide', colSpan: 2, row: 1, column: 0 },
];
...
describe('widgetGridModel', () => {
  ...
  it('cannot create an empty top row by moving its only widget down', () => {
    const fullWidth: WidgetPlacement[] = [
      { id: 'full', type: 'muscleVolumeFull', colSpan: 3, row: 0, column: 0 },
      { id: 'small', type: 'tonnageCompact', colSpan: 1, row: 1, column: 0 },
    ];

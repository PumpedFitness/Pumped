 ...
 * wired per key in `useQuickActions`, which is where navigation and the
 * current workout live. Keeping the registry free of behaviour is what lets
 * the user's selection be a plain array of keys in MMKV.
 */
